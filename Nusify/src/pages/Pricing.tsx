...
const faqs = [
  {
    ...
    answer:
      "Anda cukup menyiapkan profil bisnis, logo, dan deskripsi layanan atau produk yang ingin ditampilkan. Kami akan membantu merapikan kontennya untuk Anda.",
  },
  {
    question: "Berapa biaya perpanjangan website setiap tahun?",
    answer:
      "Biaya perpanjangan meliputi biaya domain dan hosting. Harganya bervariasi mulai dari 500rb - 1.5jt per tahun tergantung paket yang dipilih.",
  },
  {
    question: "Berapa lama proses pembuatan website?",
    answer:
      "Tergantung tingkat kerumitan, biasanya berkisar antara 7 hingga 21 hari kerja.",
  },
  {
    question: "Apakah website saya akan muncul di Google?",
    answer:
      "Ya, semua paket kami sudah termasuk optimasi SEO dasar agar website Anda mudah ditemukan di mesin pencari.",
  },
];
    ...
    <div className="relative min-h-screen bg-slate-50 dark:bg-slate-900 overflow-hidden">
      ...
      <header className="pt-32 pb-20 px-6 max-w-7xl mx-auto text-center">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
          Pilih paket yang sesuai dengan kebutuhan bisnis Anda. Transparan,
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 pb-32">
        ...
        >
          ...
          <p className="text-slate-500 max-w-3xl mx-auto">
            Kami memberikan solusi website yang tidak hanya cantik secara
            visual, tapi juga performa tinggi dan ramah Google (SEO Friendly).
          </p>
        </div>
          ...
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <div className="relative z-10">
                <h3
                  className={`text-sm font-black uppercase tracking-widest mb-4 italic flex items-center gap-2 ${plan.isPopular ? "text-blue-400" : "opacity-70"}`}
                >
                  {plan.name}
                  {plan.isPopular && (
                    <span className="inline-block px-2 py-0.5 rounded-full bg-blue-500/20 text-[10px] not-italic text-blue-300 border border-blue-500/30">
                      Most Popular
                    </span>
                  )}
                </h3>
                ...
                <div className="flex items-baseline gap-1 mb-6 group-hover:translate-x-1 transition-transform duration-300">
                  ...
                  <span
                    className={`text-4xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r ${plan.isPopular ? "from-white to-blue-200" : "from-slate-900 to-slate-700 dark:from-white dark:to-slate-400"}`}
                  >
                    {plan.price}
                  </span>
                  {plan.price !== "Custom" && (
                ...
                <p className="text-sm mb-8 opacity-70 leading-relaxed min-h-[40px]">
                  {plan.description}
                </p>
                ...
                <ul className="space-y-4 mb-10 grow">
                  {plan.features.map((feature, fIdx) => (
                    <li
                      key={fIdx}
                      className="flex items-start gap-3 text-sm font-medium group/item transition-all duration-300 hover:translate-x-1"
                    >
                      <div
                        className={`p-1 rounded-full ${plan.isPopular ? "bg-blue-500/20 text-blue-300" : "bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400"} transition-all duration-300 group-hover/item:scale-110 group-hover/item:rotate-12`}
                      >
                        <Check className="w-3.5 h-3.5" strokeWidth={3} />
                      </div>
                      <span
                        className={`opacity-90 group-hover/item:opacity-100 transition-opacity ${plan.isPopular ? "text-slate-100" : "text-slate-700 dark:text-slate-300"}`}
                      >
                        {feature}
                      </span>
                    </li>
                ...
                <button
                  onClick={() =>
                    navigate("/payment", {
                      state: { name: plan.name, price: plan.price },
                    })
                  }
          ...
          <div className="p-6 md:p-12 space-y-4">
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  <span
                    className={`font-bold transition-colors ${activeFaq === idx ? "text-blue-600" : "text-white"}`}
                  >
                    {faq.question}
                  </span>
                  <ChevronDown
                    className={`w-5 h-5 text-slate-500 transition-transform ${activeFaq === idx ? "rotate-180" : ""}`}
                  />
                </button>
                {activeFaq === idx && (
      ...
      <section className="max-w-7xl mx-auto px-6 mb-32 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white mb-8 leading-none">
            Berlokasi di Yogyakarta <br />{" "}
            <span className="text-slate-400">Seluruh Indonesia</span>
          </h2>
          <p className="text-slate-500 mb-8 border-l-4 border-blue-600 pl-6 py-2">
            Kami melayani klien dari berbagai kota di Indonesia. Koordinasi
            dilakukan secara online melaui Meet/WhatsApp untuk efisiensi waktu
            Bapak/Ibu.
          </p>
        ...
        <div className="aspect-square bg-slate-200 dark:bg-slate-800 rounded-[3rem] overflow-hidden border-8 border-white dark:border-slate-700 shadow-2xl relative">
          {/* Map Placeholder */}
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.2803801539585!2d110.40655531226406!3d-7.760060192226729!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a599bd3bdc4ef%3A0x6f1714b0c4544586!2sUniversitas%20Amikom%20Yogyakarta!5e0!3m2!1sid!2sid!4v1773330223012!5m2!1sid!2sid"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
